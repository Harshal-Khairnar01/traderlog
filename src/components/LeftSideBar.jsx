...
const LeftSidebar = ({ setSidebarOpen }) => {
  ...
  return (
    <aside className="fixed top-0 left-0 z-50 w-64 h-screen p-4 flex flex-col bg-slate-950 border-r border-slate-800">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold text-white">TradeTrackerrr</h2>
        {setSidebarOpen && (
          <button onClick={() => setSidebarOpen(false)} className="text-gray-400 hover:text-white p-1 rounded-md lg:hidden" aria-label="Close sidebar">
